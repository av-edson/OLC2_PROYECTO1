...
export class NavBar extends React.Component{
  ...
  state={
    ...
    render() {
        return (
            <div className="barra">
                <nav className="navbar navbar-light" style={{backgroundColor:"#7F8C8D"}}>
                  <form className="container-fluid justify-content-start">
                    <button className="btn btn-outline-dark btn-lg" type="button" onClick={()=>this.changeView(1)} disabled>JOLC
                    ...
                    <button className="btn btn-outline-dark btn-lg" type="button" onClick={()=>this.changeView(1)}>HOME
                    ...
                    <button className="btn btn-outline-dark btn-lg" type="button" onClick={()=>this.changeView(2)}>Editor
                    ...
                    <button className="btn btn-outline-dark btn-lg" type="button" onClick={()=>this.changeView(3)}>Reportes
